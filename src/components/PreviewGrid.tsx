...
const PreviewGrid: React.FC = () => {
  ...
  console.log('PreviewGrid files:', files); // Debug log
  ...
  return (
    <div className="mt-8 animate-scale-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        {files.map((file) => {
          console.log('Rendering file:', file.id, file.preview); // Debug log per file
          return (
            <div 
              key={file.id} 
              ...
              {file.preview ? (
                <div className="absolute inset-0 flex items-center justify-center animate-blur-in">
                  <img 
                    ...
                    onError={(e) => {
                      console.error('Error loading preview:', file.preview);
